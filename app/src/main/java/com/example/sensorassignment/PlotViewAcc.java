...
public class PlotViewAcc extends View {
    ...
    public PlotViewAcc(Context context) {
        super(context);
    }

    public PlotViewAcc(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PlotViewAcc(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public PlotViewAcc(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("Time Passed (x100 ms)", 350, 710, blackText);
        canvas.drawText("Accel", 25, 320, blackText);
        canvas.drawText("(m/s^2)", 10, 380, blackText);
        ...
        canvas.drawText("1.5", 140, 550, blackmargins);
        canvas.drawText("3", 140, 500, blackmargins);
        canvas.drawText("4.5", 140, 450, blackmargins);
        canvas.drawText("6", 140, 400, blackmargins);
        canvas.drawText("7.5", 140, 350, blackmargins);
        canvas.drawText("9", 140, 300, blackmargins);
        canvas.drawText("10.5", 140, 250, blackmargins);
        canvas.drawText("12", 140, 200, blackmargins);
        canvas.drawText("13.5", 140, 150, blackmargins);
        canvas.drawText("15", 140, 100, blackmargins);
        ...
        for (int i = 0; i < al.size(); i++){
            canvas.drawCircle(((float) (i*55) + 200), ( (float) (430 - ((al.get(i) * 15)) )), 10, blue);

        }
        for (int i = 0; i < al.size() - 1; i++) {
            canvas.drawLine(((float) (i*55) + 200),( (float) (430 - (al.get(i) * 15))), ((float) ((i+1)*55) + 200), ((float) (430 - (al.get(i+1) * 15))), blueline);
        }

        for (int i = 0; i < sVals.size(); i++){
            canvas.drawCircle(((float) (i*55) + 200), ((float) (430 - (sVals.get(i) * 15))), 10, green);
        }
        for (int i = 0; i < sVals.size() - 1; i++) {
            canvas.drawLine(((float) (i*55) + 200),((float) (430 - (sVals.get(i) * 15))), ((float) ((i+1)*55) + 200), ((float) (430 - (sVals.get(i+1) * 15))), greenline);
        }

        for (int i = 0; i < StDev.size(); i++){
            canvas.drawCircle(((float) (i * 55) + 200), (600 - (float) ((StDev.get(i)))), 10, yellow);
        }
        for (int i = 0; i < StDev.size() - 1; i++) {
            canvas.drawLine(((float) (i*55) + 200),(600 - (float) ((StDev.get(i)))), ((float) ((i+1)*55) + 200), (600 - (float) ((StDev.get(i+1)))), yellowline);
        }
    }
